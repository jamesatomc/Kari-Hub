...
func TestUnreleasedIncentivesInvariant(t *testing.T) {
	...
	app.BankKeeper.InitGenesis(
		...
		&banktypes.GenesisState{
			Balances: []banktypes.Balance{{
				...
				Coins:   sdk.NewCoins(sdk.NewCoin("ukari", sdk.NewInt(123)), sdk.NewCoin("uastro", sdk.NewInt(456))),
			}},
		},
	)
	...
	sum of unreleased incentives: 7192uastro,8637ukari
	module account balances: 456uastro,123ukari
`,
		msg,
	)
	...
	app.BankKeeper.InitGenesis(
		...
		&banktypes.GenesisState{
			Balances: []banktypes.Balance{{
				Address: maccAddr.String(),
				Coins:   sdk.NewCoins(sdk.NewCoin("ukari", sdk.NewInt(8637)), sdk.NewCoin("uastro", sdk.NewInt(7192))),
			}},
		},
	)

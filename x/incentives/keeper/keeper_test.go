...
var mockSchedules = []types.Schedule{{
	...
	TotalAmount:    sdk.NewCoins(sdk.NewCoin("ukari", sdk.NewInt(10000))),
	ReleasedAmount: sdk.NewCoins(),
}}
...
var mockSchedulesReleased = []types.Schedule{{
	...
	EndTime:        time.Unix(20000, 0),
	TotalAmount:    sdk.NewCoins(sdk.NewCoin("ukari", sdk.NewInt(12345)), sdk.NewCoin("uastro", sdk.NewInt(69420))),
	ReleasedAmount: sdk.NewCoins(sdk.NewCoin("ukari", sdk.NewInt(11066)), sdk.NewCoin("uastro", sdk.NewInt(62228))),
}, {
	Id:             2,
	StartTime:      time.Unix(15000, 0),
	EndTime:        time.Unix(30000, 0),
	TotalAmount:    sdk.NewCoins(sdk.NewCoin("ukari", sdk.NewInt(10000))),
	ReleasedAmount: sdk.NewCoins(sdk.NewCoin("ukari", sdk.NewInt(2642))),
}}

...
func setupRewardTest(t *testing.T, schedules []types.Schedule) *testSuite {
	...
	// calculate the total kari token amount needed to be given to incentives
	// module account
...
func TestTwoActiveSchedules(t *testing.T) {
	...
	// set time to 13333
	// schedule 1 should release 4114 ukari + 23137 uastro (see reward_test.go for calculation)
	// schedule 2 should release nothing
	suite.setBlockHeight(1)
	suite.setBlockTime(13333)
	expectedBlockReward := sdk.NewCoins(sdk.NewCoin("ukari", sdk.NewInt(4114)), sdk.NewCoin("uastro", sdk.NewInt(23137)))
	...
	// set time to 18964
	// schedule 1 should release 6952 ukari + 39091 uastro (see reward_test.go for calculation)
	// schedule 2 should release 10000 * 1e18 * 3964 / 15000 / 1e18 = 2642 ukari
	// total: 9594 ukari + 39091 uastro
	suite.setBlockTime(18964)
	expectedBlockReward = sdk.NewCoins(sdk.NewCoin("ukari", sdk.NewInt(9594)), sdk.NewCoin("uastro", sdk.NewInt(39091)))
